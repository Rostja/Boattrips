...
import com.tripsdev.boattrip.entity.Room;
...
public interface RoomRepository extends JpaRepository<Room,Long> {
    ...
    List<Room> findAvailableRoomsByDateAndTypes(@Param("checkInDate") LocalDate checkInDate, @Param("checkOutDate") LocalDate checkOutDate, @Param("roomType") String roomType);
